...
SETTINGS defaultSettings = {
  90, //Время подкидывания при розжиге 
  11, //Время подкидывания при нагреве
  4, //Время подкидывания при подержании
  27, //Промежуток между подкидываниями
  1200, //Время отведённое на розжик
  100, //Время фиксации пламяни
  20, //На каком проценте начинается фиксация
  75, //скорость вентилятора при розжиге
  100, //скорость вентилятора при нагреве
  80, //скорость вентилятора при поддержании
  0, //скорость вентилятора при ожидании
  49, //Установка температуры
  4, //Гистерезис
